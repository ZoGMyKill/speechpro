...
7. На фронт отправляется отчет пользователю с возможностью скачать его в pdf.
9. Пользователь может ознакомиться с отчетом и использовать его для улучшения своих навыков публичных выступлений.
...
### Блок-схема:
![block-shema](../figures/block-shema.jpg)
