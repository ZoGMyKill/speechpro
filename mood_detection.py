...
def detect_faces_and_emotions(image):
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(image, text, (x, y + h + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2)
...
def main():
    ...
    if uploaded_file is not None:
        ...
        while True:
            ...
            processed_video_container.image(processed_frame, channels="RGB", use_column_width=True)
